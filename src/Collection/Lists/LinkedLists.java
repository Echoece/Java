...
import java.util.*;
// Linked lists extends the AbstractList class and implements List and Deque interfaces.
public class LinkedLists {
    public static void main(String[] args) {
        ...
        //Returns an iterator over the elements in this deque in reverse sequential order in forward direction only.
