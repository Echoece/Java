...
// same rule as interface, if we inherit from an abstract class we must provide the override. If it doesnt ,
// then the inherited class must be declared abstract as well.
