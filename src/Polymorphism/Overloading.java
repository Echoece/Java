...
public class Overloading {
    ...
    // 3) throw different checked or unchekced exception
    int a,b;
    ...
    // method overloading
    // this is a special case, since all the three have same number of arguments, in case we pass another type of parameter, for exameple
