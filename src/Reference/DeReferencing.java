...
public class DeReferencing {
    ...
    private static void modifiedArray(int[] array){
        ...
        array[0] = 2;
        // we are de-referencing the reference, in other words this pointer is pointing to a different location with the new keyword.
        // at this point only myarray and anotherarry pointing to the original array location , and array is pointing to the new location.
