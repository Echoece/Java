...
//Add Action Listeners
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getActionCommand() == "Add New Contact") {
            ...
            JOptionPane.showMessageDialog(frame, "About Address Book: Created By Rajat Saxena", "About Address Book",
...
class OperationHandler implements ListSelectionListener,
    ...
    public void ViewAllContacts() {
        ...
        String columnNames[] = {"First Name", "Last Name", "Nickname", "E Mail Address", "Address", "Phone No.", "Webpage", "B'day"};
